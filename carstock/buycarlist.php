...
<section class="content-header">
  <h1><i class="fa fa-briefcase repair-car-heading"> <span class="repair-car-txt">Compras de máquinas </span></i></h1>
  <ol class="breadcrumb">
...
<div class="row">
  <div class="col-xs-12">
    ...
    <div align="right" style="margin-bottom:1%;"> 
      <a class="btn btn-success" data-toggle="tooltip" href="<?php echo WEB_URL; ?>carstock/buycar.php" data-original-title="Add Car">
        <i class="fa fa-plus"></i>
      </a> 
      <a class="btn btn-warning" data-toggle="tooltip" href="<?php echo WEB_URL; ?>dashboard.php" data-original-title="Dashboard">
    ...
    <div class="box box-success">
      <div class="box-header">
        ...
        <form enctype="multipart/form-data" method="POST" action="file-upload.php" style="margin-bottom: 0px;">
          <div style="margin-top:10px;">
            <input type="file" name="uploadFile"/>
            <a href="#" class="btn btn-info btn-sm remove">
              <span class="glyphicon glyphicon-upload"></span> Upload File
            </a>
            <button style="display: none;" id="btnSubmit" type="submit">Send</button>
          </div>
        </form>
      </div>
      <!-- /.box-header -->
      <table class="table sakotable table-bordered table-striped dt-responsive">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center"><?php if($row['car_status'] == '0'){echo '<span class="label label-success">STOCK</span>';} else {echo '<span class="label label-danger">VENDIDA</span>';} ?></td>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          <h3 style="text-decoration:underline;">Car Information</h3>
