...
<section class="content-header">
  <h1><i class="fa fa-briefcase repair-car-heading"><span class="repair-car-txt">Vender máquina</span></i></h1>
  <ol class="breadcrumb">
        ...
        <div class="box-body">
          <div class="col-md-12" style="padding-top:10px;">
            ...
            <div class="text-center">
              <div style="font-size:25px;font-weight:bold;color:green;text-decoration:underline;">Documento: <?php echo $invoice_id; ?></div>
            </div>
...
                 <a class="btn btn-warning btnsp" data-toggle="tooltip" href="<?php echo WEB_URL; ?>carstock/sellcarlist.php" data-original-title="Back"><i class="fa fa-reply fa-2x"></i><br/>
      ...
      <div class="box box-success" id="box_model">
        <div class="box-body">
          <div class="box-header">
            <h3 class="box-title"><i class="fa fa-briefcase repair-car-heading"><span class="repair-car-txt">Informacion de la máquina</span></i></h3>
          </div>
          <?php
          ...
          <div style="width:98%;height:auto;border:solid 1px #ccc;padding:10px;margin:10px;">
            ...
            <div class="col-md-5 text-left">
              ...
              <div><b>Marca:</b> <?php echo $row['make_name']; ?>; <b>Modelo:</b> <?php echo $row['model_name']; ?>; <b>Year:</b> <?php echo $row['year_name']; ?></div>
              <div><b>Características de la máquina:</b> <span style="font-size:12px;" class="label label-danger"><?php echo $row['color_name']; ?></span></div>
              <div><b>Juegos:</b> <?php echo $row['door_name']; ?></div>
            ...
            <div class="col-md-3 text-left">
              ...
              <br/> -->
              <br/>
              <div class="label label-danger" style="font-size:15px;"><i class="fa fa-check-square-o" aria-hidden="true"></i>  Preicio Sugerido: <?php echo $currency; ?><?php echo number_format($row['asking_price'],2); ?></div>
              <br/>
              <br/>
      ...
      <div class="box box-success">
        <div class="box-body">
          ...
          <div class="form-group col-md-4">
            <label for="txtBuyerName"><span style="color:red;">*</span> Cliente :</label>
      ...
      <div class="box box-success" id="box_year">
        <div class="box-body">
          <div class="box-header">
            <h3 class="box-title"><i class="fa fa-info"></i> Información de la venta</h3>
          </div>
          <div class="form-group col-md-4">
            <label for="txtBuyPrice"><span style="color:red;">*</span> Precio de Venta :</label>
          ...
          <div class="form-group col-md-12">
            <label for="ddlServiceWarranty">Garantia:</label>
