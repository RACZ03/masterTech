    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        ...
        <?php
			...
			<td align="center"><?php if($row['approve'] == 1){echo "<span class='label label-success'>Approved</span>";} else {echo "<span class='label label-danger'>Not Yet</span>";} ?></td>		
			<td align="center"><?php if($row['status'] == 1){echo "<span class='label label-success'>Enable</span>";} else {echo "<span class='label label-danger'>Disable</span>";} ?></td>		
            <td>
