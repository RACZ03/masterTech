...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Find Slot Machine Estimate</li>
  </ol>
</section>
<!-- Main content -->
      ...
      <div class="box box-success" id="box_model">
        <div class="box-body">
          <div class="box-header">
            <h3 class="box-title"><i class="fa fa-search"></i> Buscar por ID de la Orden</h3>
          </div>
          ...
          <div class="form-group col-md-12">
            <button type="submit" class="btn btn-large btn-block btn-bg"><b>BUSCAR</b></button>
          </div>
        </div>
        <!-- /.box-body -->
      </div>
    ...
    <div class="box box-success" id="box_model">
      <div class="box-body">
        ...
        <?php if (!empty($_POST)) { 
				...
				if(!empty($row) && $_SESSION['objMech']['user_id']==$row['mechanics_id']){
        ...
        <div style="width:98%;height:auto;border:solid 1px #ccc;padding:10px;margin:10px;">
          ...
          <div class="col-md-3 text-left">
            ...
            <div><b>Marca:</b> <?php echo $row['make_name']; ?></div>
            <div><b>Modelo:</b> <?php echo $row['model_name']; ?></div>
            <div><b>Serie:</b> <?php echo $row['model_name']; ?></div>
          ...
          <div class="col-md-3 text-left">
            ...
            <div><b>Fecha de la Orden:</b> <?php echo $row['added_date']; ?></div>
          ...
          <div class="col-md-3 text-left">
            ...
            <div class="form-group text-right"><a href="<?php echo WEB_URL; ?>mech_panel/estimate_form.php?carid=<?php echo $row['car_id']; ?>&customer_id=<?php echo $row['customer_id']; ?>&mechanics_id=<?php echo $row['mechanics_id'];?>" style="font-weight:bold;font-size:17px;" class="btn btn-danger"><i class="fa fa-plus"></i> Agregar Cotización</a></div>
            <div class="form-group text-right"><a data-toggle="tooltip" href="javascript:;" onClick="$('#estimate_view_<?php echo $row['car_id']; ?>').modal('show');" data-original-title="All Estimate History" style="font-weight:bold;font-size:17px;" class="btn btn-primary"><i class="fa fa-calendar-check-o"></i> Consultar Cotizaciónes</a></div>
          </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body" style="overflow:auto;">
                  <table class="table">
                    ...
                    <tbody>
                      <?php 
							$car_estimate_data = $wms->getRepairCarAllEstimateData($link,$row['car_id'],$row['customer_id'],$row['mechanics_id']);
                      ...
                      <tr>
                        ...
                        <td><a style="padding: 2px 6px; !important;" data-toggle="tooltip" data-original-title="Edit Estimate" href="<?php echo WEB_URL; ?>mech_panel/estimate_form.php?carid=<?php echo $row['car_id']; ?>&customer_id=<?php echo $row['customer_id']; ?>&mechanics_id=<?php echo $row['mechanics_id']; ?>&estimate_no=<?php echo $cedata['estimate_no']; ?>" style="font-weight:bold;font-size:14px;" class="btn btn-success"><i class="fa fa-edit"></i> </a></td>
                      </tr>
                      <?php } ?>
                      <?php } ?>
                    </tbody>
