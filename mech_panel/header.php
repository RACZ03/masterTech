               ...
               <nav class="navbar navbar-static-top">
                    ...
                    <div class="navbar-custom-menu">
                         <ul class="nav navbar-nav">
                              <li class="dropdown messages-menu"> <a href="<?php echo WEB_URL; ?>" target="_blank"> <i
                              ...
                              <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle"
                                        data-toggle="dropdown"> <img src="<?php echo $user_image; ?>" class="user-image"
                                             alt="User Image"> <span
                                             class="hidden-xs"><?php echo !empty($_SESSION['objMech']['name']) ? $_SESSION['objMech']['name'] : ''; ?></span>
                                   </a>
                                   <ul class="dropdown-menu">
                                        ...
                                        <li class="user-header"> <img src="<?php echo $user_image; ?>"
                                             ...
                                             <p style="text-transform:capitalize;"> <b
                                                       style="color:#fff;font-weight:normal !important;"><?php echo !empty($_SESSION['objMech']['name']) ? $_SESSION['objMech']['name'] : ''; ?></b>
                                                  <small
                                        ...
                                        <li class="user-footer">
                                             <div class="pull-left"> <a
                                                       href="<?php echo WEB_URL; ?>mech_panel/profile.php"
          ...
          <aside class="main-sidebar">
               ...
               <div class="user-panel admin_header_border header_admin_border">
                    ...
                    <div class="pull-left info">
                         ...
                         <a href="<?php echo WEB_URL; ?>cust_panel/profile.php"><i
               ...
               <section class="sidebar" style="margin-top:10px;">
                    ...
                    <ul class="sidebar-menu">
                         ...
                         <!-- <li
                              class="<?php if($page_name != '' && $page_name == 'mech_dashboard'){echo 'active';}?> tm10">
                              <a href="<?php echo WEB_URL; ?>mech_panel/mech_dashboard.php"><i
                                        class="fa fa-dashboard"></i> <span>Dashboard</span></a> </li>
                         <li
                              class="treeview <?php if($page_name != '' && $page_name == 'workstatus' || $page_name == 'addworkstatus'){echo 'active';}?>">
                              <a href="<?php echo WEB_URL; ?>mech_panel/workstatus.php"> <i class="fa fa-wrench"></i>
                                   <span>Daily Work</span></a></li> -->
                         <li
                              class="treeview <?php if($page_name != '' && $page_name == 'addcar' || $page_name == 'technicianlist'){echo 'active';}?>">
                              <a href="<?php echo WEB_URL; ?>mech_panel/technicianlist.php"> <i class="fa fa-wrench"></i>
                                   <span>Ordenes de Trabajo</span> </a>
                         </li>
                         <li class="treeview <?php if($page_name != '' && $page_name == 'findcar' || $page_name == 'estimate_form'){echo 'active';}?>"> 
                              <a href="<?php echo WEB_URL; ?>mech_panel/findcar.php"> <i class="fa fa-calculator"></i> 
                              <span>Cotizar Reparacion</span></a>
                         </li>
                         <!-- <li
                              class="treeview <?php if($page_name != '' && $page_name == 'pagebuilder'){echo 'active';}?>">
                              <a href="<?php echo WEB_URL; ?>mech_panel/pagebuilder.php"> <i
                                        class="fa fa-file-powerpoint-o"></i> <span>Profile Page</span></a></li>
                         <li
                              class="treeview <?php if($page_name != '' && $page_name == 'rptmsalary'){echo 'active';}?>">
                              <a href="<?php echo WEB_URL; ?>mech_panel/rptmsalary.php"> <i class="fa fa-money"></i>
                                   <span>Salary Report</span></a></li> -->
                    </ul>
               </section>
               <!-- /.sidebar -->
          </aside>
