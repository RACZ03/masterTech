...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo WEB_URL?>repaircar/carlist.php"> Repair Slot Machine</a></li>
          ...
          <div class="box-body">
			...
			<!-- <button type="submit" class="btn btn-success btnsp"><i class="fa fa-save fa-2x"></i><br/>
			 ...
			 <button type="submit" class="btn btn-success btnsp"><span class="print-txt"><?php echo $button_text; ?></span>&emsp;<i class="fa fa-save fa-2x"></i></button>
                ...
                Back</a>  -->
			 <a class="btn btnsp btn-color" data-toggle="tooltip" href="<?php echo WEB_URL; ?>repaircar/carlist.php" data-original-title="Back"><i class="fa fa-reply  fa-2x"></i><br/>
                Regresar</a> 
			</div>
            </div>
          </div>
